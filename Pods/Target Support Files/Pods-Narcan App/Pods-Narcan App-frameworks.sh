...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/ServiceSDK/Frameworks/ServiceCases.framework"
  install_framework "${PODS_ROOT}/ServiceSDK/Frameworks/ServiceKnowledge.framework"
  install_framework "${PODS_ROOT}/ServiceSDK/Frameworks/ServiceCore.framework"
