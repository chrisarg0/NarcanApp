...
/**
 *  Protocol which defines properties and methods which are required for all ViewControllers which
 ...
 *
 *  This method will automatically call <[SOSSessionBaseViewController setSOSPaused:]> 
 *  The value will be derived from the negation of <[SOSSessionBaseViewController isSOSPaused]>
 *  If you wish to handle the muted state in a different way, you can ignore this action and use
 *  <[SOSSessionBaseViewController setSOSPaused:]> directly instead.
 *
 ...
 *
 *  This method will automatically call <[SOSSessionBaseViewController setSOSMuted:]>
 *  The value will be derived from the negation of <[SOSSessionBaseViewController isSOSMuted]>
 *  If you wish to handle the muted state in a different way, you can ignore this action and use
 *  <[SOSSessionBaseViewController setSOSMuted:]> directly instead.
 *
 *  @warning This method is used to communicate between the UI API and the SOS backend. If you wish to
 *  override this method you can do so safely; however you must call this method on `super`. Failure to do
 *  so will result in undefined and likely broken behavior from SOS.
 ...
 *  handling user confirmation remains as an implementation detail for the view controller.<br><br>
 *
