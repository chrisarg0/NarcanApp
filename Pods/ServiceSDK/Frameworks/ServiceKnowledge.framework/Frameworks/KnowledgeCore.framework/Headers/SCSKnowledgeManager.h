...
@class SCSCategoryGroup, SCSCategory, SCSArticle, SCSArticleQuery, SFUserAccount;

/**
 A `SCSKnowledgeManager` object is used to interact with knowledge data such as category groups, categories, and articles.
 
 The knowledge manager abstracts the storage, network retrieval, and queries for interacting with data in an efficient fashion. You can use this
 object to fetch categories and articles from your org. Once fetched, you can use this object to get cached content. See the <SCSArticleQuery>
...
/**
 ...
 This singleton instance automatically uses the user account currently selected within [SCServiceCloud]([SCServiceCloud userAccount]).
...
/**
 Designated initializer for creating a knowledge manager with the given user account.

 @param userAccount User account to use.

 @return Initialized knowledge manager.
 */
- (instancetype)initWithUserAccount:(SFUserAccount*)userAccount;
...
/**
 ...
 @param completionHandler Optional completion block to be called when the operation completes.
 */
...
/**
 ...
 @return `YES` if this instance has successfully completed `fetchAllCategoriesWithCompletionHandler:`, otherwise `NO`.
 */
...
/**
 ...
 @return Article matching the given ID, or `nil` if no article is found in the cache with that name.
 @see SCSArticle
 */
