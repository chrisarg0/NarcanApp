 ...
 *
 *  @see <[SCSChat startSessionWithConfiguration:completion:]>
 */
 ...
 *  This method will begin the process for starting a Live Agent Chat session.
 *
 *  __NOTE__: Calling <[SCSChat stopSession]> at any point after calling <[SCSChat startSessionWithConfiguration:]>
 ...
 *
 *  @see [SCSChat stopSessionWithCompletion:]
 */
- (void)stopSession;
