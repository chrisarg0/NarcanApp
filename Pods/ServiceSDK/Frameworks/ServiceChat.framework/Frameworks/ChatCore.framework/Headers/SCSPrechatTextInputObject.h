...
/**
 * A `SCSPrechatTextInputObject` specifies a pre-chat text input field that is
 * displayed before a chat session is initiated.
 *
 * Use the `required` property to specify whether this field must be filled in
...
/**
 *  Determines if the field must be filled before the prechat form can be submitted.
 */
@property (nonatomic, getter=isRequired) BOOL required;

/**
 *  Sets a maximum length for the text entered in the prechat field.
 */
 ...
 *  This object will be displayed in the prechat window for the user to fill out.
 *
